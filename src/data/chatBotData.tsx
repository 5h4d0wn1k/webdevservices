...
export const chatBotData: ChatBotDataType = {
  defaultMessages: [
    {
      id: '1',
      content: "Hi there! I'm the Shadownik(SWNK) Assistant, your guide to our web development services. How can I help you today?",
      sender: 'bot',
  ...
  botResponses: {
    ...
    contact: [
      "You can contact our Shadownik(SWNK) team for web development inquiries at support@swnk.in or call us at +91 9165644843.",
  ...
  headerTitle: "Shadownik(SWNK) Assistant",
