          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-400 mb-6">
                Get the latest web development insights, trends, and Shadownik(Swnk) news delivered directly to your inbox.
              </p>
                ...
                {isSuccess ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <p className="text-xs text-gray-500 pt-2">
                      By subscribing, you agree to our <a href="/privacy-policy" className="text-primary hover:underline">Privacy Policy</a> and consent to receive updates from Shadownik(Swnk).
                    </p>
                  </form>
                )}
              </div>
